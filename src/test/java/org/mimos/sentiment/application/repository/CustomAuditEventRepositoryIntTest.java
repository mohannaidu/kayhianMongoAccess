...
import org.mimos.sentiment.application.config.audit.AuditEventConverter;
import org.mimos.sentiment.application.domain.PersistentAuditEvent;
...
import static org.mimos.sentiment.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
